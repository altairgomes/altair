...
plt.legend([l, j, m], ['STE', 'JUP300', 'Eme2005'], numpoints=1, loc=3, labelspacing=0.25, borderpad=0.1, handlelength=0.5, prop={'size':sizel})
...
fig.savefig('{}_ephemeris_2005.eps'.format(obj), format='eps', dpi=300, bbox_inches='tight')
