...
plt.plot(eph[0] - 2451544.5, f6(myodrde.output.beta, np.vstack([eph[0], eph[1]])), label='Ajuste1')
...
myodrra = odrpack.ODR(mydatara, linearra, beta0=[200.0, 12.7, 0.0, 1.0, 1.0, 0.0])
