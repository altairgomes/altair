...
A = np.vstack([y[0] - 2451544.5, np.sin(y[3]*u.deg), np.cos(y[3]*u.deg), np.ones(len(y[3]))]).T
...
plt.plot(eph[0] - 2451544.5, f(myodrde.output.beta, np.vstack([eph[0], eph[1]])), label='Ajuste1')
...
B = np.vstack([y[0] - 2451544.5, np.sin(y[3]*u.deg)*np.cos(y[3]*u.deg), np.sin(y[3]*u.deg), np.cos(y[3]*u.deg), np.ones(len(y[3]))]).T
...
plt.plot(eph[0] - 2451544.5, g(myodrra.output.beta, np.vstack([eph[0], eph[1]])), label='Ajuste1')
