...
coords = np.loadtxt("Carme_laurene.eph", skiprows=3, usecols=(2, 4, 5, 6, 7, 8, 9), unpack=True, dtype ='S20', ndmin=1)
coor = coords[1]
...
tempo = np.loadtxt("Carme_JPL.eph", skiprows=3, usecols=(2,), unpack=True, ndmin=1)
ephcoord = np.loadtxt("Carme_JPL.eph", skiprows=3, usecols=(2, 4, 5, 6, 7, 8, 9), unpack=True, dtype ='S20', ndmin=1)
coor = coords[1]
