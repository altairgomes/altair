...
myodrde = odrpack.ODR(mydatade, linearde, beta0=[200.0, 14.7, 0.0, 1.0, 1.0, 0.0], maxit=300)
...
myodrra = odrpack.ODR(mydatara, linearra, beta0=[200.0, 11.7, 0.0, 1.0, 1.0, 0.0], maxit=400)
