...
#plt.plot(pos_time.jd - 2451544.5, dalfapos.mas, '+', label='Right Ascencion')
#plt.plot(pos_time.jd - 2451544.5, ddeltapos.mas, 'x', label='Declination')
...
fig.savefig('JPL-EME_Triton.png',dpi=100, bbox_inches='tight')
plt.clf()
